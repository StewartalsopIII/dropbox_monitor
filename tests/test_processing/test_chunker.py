...
class TestAudioChunker(unittest.TestCase):
    ...
    def _create_test_files(self):
        ...
        # Create file with explicit silence points
        self._create_audio_file(
            self.silence_file,
            duration=10,
            content="sine=440:d=2[a1];sine=0:d=2[a2];sine=440:d=2[a3];[a1][a2][a3]concat=n=3:v=0:a=1"
        )
    ...
    def test_context_manager(self):
        ...
        with AudioChunker() as chunker:
            ...
            # Verify temp directory exists and capture its path
            self.assertIsNotNone(chunker.temp_dir)
